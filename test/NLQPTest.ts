...
function executeQuery(query: nlqp.Query): Array<string> {
  ...
  if (query.projects.length !== 0) {
    ...
    queryString = `
    (query
      (select "entity eavs" :entity employee :attribute "salary" :value employee|salary)
      (select "is a attributes" :entity employee :collection "AUTOGENERATED employee THIS SHOULDN'T SHOW UP ANYWHERE")
      (project! :employee employee :employee|salary employee|salary)
    )
    `;
...
let phrases = [ 
  ...
  */
  ...
  //'test data that is an employee', // infinite loop!!!
  /*
