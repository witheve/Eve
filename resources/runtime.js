...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t14059 && (cljs.core.t14059 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta14060 = g;
    ...
    }, cljs.core.t14059.cljs$lang$type = !0, cljs.core.t14059.cljs$lang$ctorStr = "cljs.core/t14059", cljs.core.t14059.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t14059");
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c;
    }(), cljs.core.t14059.prototype.apply = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c;
    }(), cljs.core.t14059.prototype.cljs$core$Fn$ = !0, cljs.core.t14059.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta14060;
    }, cljs.core.t14059.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t14059(this.meta, this.o, this.with_meta, c);
    }, cljs.core.__GT_t14059 = function(b, c, f, g) {
      return new cljs.core.t14059(b, c, f, g);
    });
    return new cljs.core.t14059(c, b, with_meta, null);
...
aurora.runtime = {};
aurora.runtime.table = {};
aurora.runtime.table.ITable = function() {
  return{};
}();
aurora.runtime.table._add_column = function(a, b, c) {
  if (a ? a.aurora$runtime$table$ITable$_add_column$arity$3 : a) {
    return a.aurora$runtime$table$ITable$_add_column$arity$3(a, b, c);
  }
  var d;
  d = aurora.runtime.table._add_column[goog.typeOf(null == a ? null : a)];
  if (!d && (d = aurora.runtime.table._add_column._, !d)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-add-column", a);
  }
  return d.call(null, a, b, c);
};
aurora.runtime.table._select_column = function(a, b) {
  if (a ? a.aurora$runtime$table$ITable$_select_column$arity$2 : a) {
    return a.aurora$runtime$table$ITable$_select_column$arity$2(a, b);
  }
  var c;
  c = aurora.runtime.table._select_column[goog.typeOf(null == a ? null : a)];
  if (!c && (c = aurora.runtime.table._select_column._, !c)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-select-column", a);
  }
  return c.call(null, a, b);
};
aurora.runtime.table._columns = function(a) {
  if (a ? a.aurora$runtime$table$ITable$_columns$arity$1 : a) {
    return a.aurora$runtime$table$ITable$_columns$arity$1(a);
  }
  var b;
  b = aurora.runtime.table._columns[goog.typeOf(null == a ? null : a)];
  if (!b && (b = aurora.runtime.table._columns._, !b)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-columns", a);
  }
  return b.call(null, a);
};
aurora.runtime.table._column_headers = function(a) {
  if (a ? a.aurora$runtime$table$ITable$_column_headers$arity$1 : a) {
    return a.aurora$runtime$table$ITable$_column_headers$arity$1(a);
  }
  var b;
  b = aurora.runtime.table._column_headers[goog.typeOf(null == a ? null : a)];
  if (!b && (b = aurora.runtime.table._column_headers._, !b)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-column-headers", a);
  }
  return b.call(null, a);
};
aurora.runtime.table._rows = function(a) {
  if (a ? a.aurora$runtime$table$ITable$_rows$arity$1 : a) {
    return a.aurora$runtime$table$ITable$_rows$arity$1(a);
  }
  var b;
  b = aurora.runtime.table._rows[goog.typeOf(null == a ? null : a)];
  if (!b && (b = aurora.runtime.table._rows._, !b)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-rows", a);
  }
  return b.call(null, a);
};
aurora.runtime.table._add_row = function(a, b) {
  if (a ? a.aurora$runtime$table$ITable$_add_row$arity$2 : a) {
    return a.aurora$runtime$table$ITable$_add_row$arity$2(a, b);
  }
  var c;
  c = aurora.runtime.table._add_row[goog.typeOf(null == a ? null : a)];
  if (!c && (c = aurora.runtime.table._add_row._, !c)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-add-row", a);
  }
  return c.call(null, a, b);
};
aurora.runtime.table._select_row = function(a, b) {
  if (a ? a.aurora$runtime$table$ITable$_select_row$arity$2 : a) {
    return a.aurora$runtime$table$ITable$_select_row$arity$2(a, b);
  }
  var c;
  c = aurora.runtime.table._select_row[goog.typeOf(null == a ? null : a)];
  if (!c && (c = aurora.runtime.table._select_row._, !c)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-select-row", a);
  }
  return c.call(null, a, b);
};
aurora.runtime.table._cell = function(a, b, c) {
  if (a ? a.aurora$runtime$table$ITable$_cell$arity$3 : a) {
    return a.aurora$runtime$table$ITable$_cell$arity$3(a, b, c);
  }
  var d;
  d = aurora.runtime.table._cell[goog.typeOf(null == a ? null : a)];
  if (!d && (d = aurora.runtime.table._cell._, !d)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-cell", a);
  }
  return d.call(null, a, b, c);
};
aurora.runtime.table._update_cell = function(a, b, c, d) {
  if (a ? a.aurora$runtime$table$ITable$_update_cell$arity$4 : a) {
    return a.aurora$runtime$table$ITable$_update_cell$arity$4(a, b, c, d);
  }
  var e;
  e = aurora.runtime.table._update_cell[goog.typeOf(null == a ? null : a)];
  if (!e && (e = aurora.runtime.table._update_cell._, !e)) {
    throw cljs.core.missing_protocol.call(null, "ITable.-update-cell", a);
  }
  return e.call(null, a, b, c, d);
};
aurora.runtime.table.apply_columns = function(a, b, c) {
  return cljs.core.reduce.call(null, function(a, e) {
    var f = cljs.core.get.call(null, c, e);
    return cljs.core.truth_(f) ? cljs.core.assoc.call(null, a, e, f.call(null, a, b)) : a;
  }, a, cljs.core.range.call(null, cljs.core.count.call(null, c)));
};
aurora.runtime.table.NaiveTable = function(a, b, c) {
  this.headers = a;
  this.columns = b;
  this.rows = c;
  this.cljs$lang$protocol_mask$partition1$ = 0;
...
aurora.runtime.table.NaiveTable.cljs$lang$type = !0;
aurora.runtime.table.NaiveTable.cljs$lang$ctorStr = "aurora.runtime.table/NaiveTable";
aurora.runtime.table.NaiveTable.cljs$lang$ctorPrWriter = function(a, b, c) {
  return cljs.core._write.call(null, b, "aurora.runtime.table/NaiveTable");
};
aurora.runtime.table.NaiveTable.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = function(a, b, c) {
  return cljs.core._write.call(null, b, [cljs.core.str(cljs.core.apply.call(null, cljs.core.str, cljs.core.interpose.call(null, " | ", this.headers))), cljs.core.str("\n"), cljs.core.str(cljs.core.apply.call(null, cljs.core.str, cljs.core.interpose.call(null, "\n", cljs.core.map.call(null, cljs.core.pr_str, this.rows))))].join(""));
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$ = !0;
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_select_row$arity$2 = function(a, b) {
  return new aurora.runtime.table.NaiveTable(this.headers, this.columns, new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get.call(null, this.rows, b)], null));
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_column_headers$arity$1 = function(a) {
  return this.headers;
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_update_cell$arity$4 = function(a, b, c, d) {
  return new aurora.runtime.table.NaiveTable(this.headers, this.columns, cljs.core.assoc.call(null, this.rows, b, aurora.runtime.table.apply_columns.call(null, cljs.core.update_in.call(null, cljs.core.get.call(null, this.rows, b), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [c], null), d), cljs.core.count.call(null, this.rows), this.columns)));
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_columns$arity$1 = function(a) {
  return this.columns;
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_add_row$arity$2 = function(a, b) {
  return new aurora.runtime.table.NaiveTable(this.headers, this.columns, cljs.core.conj.call(null, this.rows, aurora.runtime.table.apply_columns.call(null, b, cljs.core.count.call(null, this.rows), this.columns)));
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_cell$arity$3 = function(a, b, c) {
  return cljs.core.get_in.call(null, this.rows, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b, c], null));
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_add_column$arity$3 = function(a, b, c) {
  var d = this;
  if (cljs.core.not.call(null, c)) {
    var e = cljs.core.count.call(null, d.columns);
    return new aurora.runtime.table.NaiveTable(cljs.core.conj.call(null, d.headers, b), cljs.core.conj.call(null, d.columns, function(a) {
      return cljs.core.get.call(null, a, e);
    }), function() {
      for (var a = d.rows, b = function(a) {
        return function(a, b) {
          return cljs.core.conj.call(null, a, null);
        };
      }(a), c = cljs.core.count.call(null, a), e = 0, l = cljs.core.transient$.call(null, cljs.core.PersistentVector.EMPTY);;) {
        if (e < c) {
          var m = e + 1, l = cljs.core.conj_BANG_.call(null, l, b.call(null, a.call(null, e), e)), e = m
        } else {
          return cljs.core.persistent_BANG_.call(null, l);
        }
      }
    }());
  }
  return new aurora.runtime.table.NaiveTable(cljs.core.conj.call(null, d.headers, b), cljs.core.conj.call(null, d.columns, c), function() {
    for (var a = d.rows, b = function(a) {
      return function(a, b) {
        return cljs.core.conj.call(null, a, c.call(null, a, b));
      };
    }(a), e = cljs.core.count.call(null, a), k = 0, l = cljs.core.transient$.call(null, cljs.core.PersistentVector.EMPTY);;) {
      if (k < e) {
        var m = k + 1, l = cljs.core.conj_BANG_.call(null, l, b.call(null, a.call(null, k), k)), k = m
      } else {
        return cljs.core.persistent_BANG_.call(null, l);
      }
    }
...
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_rows$arity$1 = function(a) {
  return this.rows;
};
aurora.runtime.table.NaiveTable.prototype.aurora$runtime$table$ITable$_select_column$arity$2 = function(a, b) {
  return new aurora.runtime.table.NaiveTable(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get.call(null, this.headers, b)], null), new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get.call(null, this.columns, b)], null), cljs.core.mapv.call(null, function(a) {
    return cljs.core.get.call(null, a, b);
  }, this.rows));
};
aurora.runtime.table.__GT_NaiveTable = function(a, b, c) {
  return new aurora.runtime.table.NaiveTable(a, b, c);
};
aurora.runtime.table.identity_column = null;
aurora.runtime.table.table_headers = new cljs.core.PersistentVector(null, 16, 5, cljs.core.PersistentVector.EMPTY_NODE, "ABCDEFGHIJKLMNOP".split(""), null);
aurora.runtime.table.table = function() {
  var a = null, b = function() {
    return new aurora.runtime.table.NaiveTable(cljs.core.PersistentVector.EMPTY, cljs.core.PersistentVector.EMPTY, cljs.core.PersistentVector.EMPTY);
  }, c = function(a) {
    return new aurora.runtime.table.NaiveTable(a, cljs.core.vec.call(null, cljs.core.repeat.call(null, cljs.core.count.call(null, a), null)), cljs.core.PersistentVector.EMPTY);
  }, d = function(a, b) {
    return new aurora.runtime.table.NaiveTable(a, b, cljs.core.PersistentVector.EMPTY);
  }, e = function(a, b, c) {
    return new aurora.runtime.table.NaiveTable(a, b, c);
  }, a = function(a, g, h) {
    switch(arguments.length) {
...
aurora.runtime.table.rows__GT_table = function(a) {
  var b = cljs.core.count.call(null, cljs.core.first.call(null, a));
  return aurora.runtime.table.table.call(null, cljs.core.subvec.call(null, aurora.runtime.table.table_headers, 0, b), cljs.core.vec.call(null, cljs.core.repeat.call(null, b, null)), a);
};
aurora.runtime.table.merge_rows = function(a, b) {
  return aurora.runtime.table.table.call(null, aurora.runtime.table._column_headers.call(null, a), aurora.runtime.table._columns.call(null, a), cljs.core.vec.call(null, cljs.core.concat.call(null, aurora.runtime.table._rows.call(null, a), aurora.runtime.table._rows.call(null, b))));
};
aurora.runtime.table.add_column = function() {
  var a = null, b = function(a) {
    return aurora.runtime.table._add_columns.call(null, a, cljs.core.get.call(null, aurora.runtime.table.header, cljs.core.count.call(null, aurora.runtime.table._columns.call(null, a)), null));
  }, c = function(a, b) {
    return aurora.runtime.table._add_column.call(null, a, b, null);
  }, d = function(a, b, c) {
    return aurora.runtime.table._add_column.call(null, a, b, c);
  }, a = function(a, f, g) {
    switch(arguments.length) {
      case 1:
        return b.call(this, a);
...
aurora.runtime.table.add_row = function(a, b) {
  return aurora.runtime.table._add_row.call(null, a, b);
};
aurora.runtime.table.row = function(a, b) {
  return aurora.runtime.table._select_row.call(null, a, b);
};
aurora.runtime.table.update_cell = function(a, b, c, d) {
  return aurora.runtime.table._update_cell.call(null, a, b, c, d);
};
aurora.runtime.table.cell = function(a, b, c) {
  return aurora.runtime.table._cell.call(null, a, b, c);
};
aurora.runtime.table.column = function(a, b) {
  return aurora.runtime.table._column.call(null, a, aurora.runtime.table.column_name);
};
aurora.runtime.table.headers = function(a) {
  return aurora.runtime.table._column_headers.call(null, a);
};
aurora.runtime.table.map_table = function(a, b) {
  var c = aurora.runtime.table._columns.call(null, b);
  return aurora.runtime.table.table.call(null, aurora.runtime.table.headers.call(null, b), c, function() {
    for (var d = aurora.runtime.table._rows.call(null, b), e = function(b) {
      return function(b, d) {
        return aurora.runtime.table.apply_columns.call(null, a.call(null, b, d), d, c);
      };
    }(d), f = cljs.core.count.call(null, d), g = 0, h = cljs.core.transient$.call(null, cljs.core.PersistentVector.EMPTY);;) {
      if (g < f) {
        var k = g + 1, h = cljs.core.conj_BANG_.call(null, h, e.call(null, d.call(null, g), g)), g = k
      } else {
