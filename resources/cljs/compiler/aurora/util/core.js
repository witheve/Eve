...
aurora.util.core.FailedCheck.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3926__auto__,k10483,else__3927__auto__){var self__ = this;
var this__3926__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k10483,new cljs.core.Keyword(null,"message","message",1968829305)))
{return self__.message;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k10483,new cljs.core.Keyword(null,"line","line",1017226086)))
{return self__.line;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k10483,new cljs.core.Keyword(null,"file","file",1017047278)))
{return self__.file;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k10483,new cljs.core.Keyword(null,"trace","trace",1124525239)))
{return self__.trace;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k10483,else__3927__auto__);
} else
{return null;
}
}
...
aurora.util.core.FailedCheck.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3931__auto__,k__3932__auto__,G__10482){var self__ = this;
var this__3931__auto____$1 = this;var pred__10485 = cljs.core.keyword_identical_QMARK_;var expr__10486 = k__3932__auto__;if(cljs.core.truth_(pred__10485.call(null,new cljs.core.Keyword(null,"message","message",1968829305),expr__10486)))
{return (new aurora.util.core.FailedCheck(G__10482,self__.line,self__.file,self__.trace,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__10485.call(null,new cljs.core.Keyword(null,"line","line",1017226086),expr__10486)))
{return (new aurora.util.core.FailedCheck(self__.message,G__10482,self__.file,self__.trace,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__10485.call(null,new cljs.core.Keyword(null,"file","file",1017047278),expr__10486)))
{return (new aurora.util.core.FailedCheck(self__.message,self__.line,G__10482,self__.trace,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__10485.call(null,new cljs.core.Keyword(null,"trace","trace",1124525239),expr__10486)))
{return (new aurora.util.core.FailedCheck(self__.message,self__.line,self__.file,G__10482,self__.__meta,self__.__extmap,null));
} else
{return (new aurora.util.core.FailedCheck(self__.message,self__.line,self__.file,self__.trace,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3932__auto__,G__10482),null));
}
}
}
}
...
aurora.util.core.FailedCheck.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3923__auto__,G__10482){var self__ = this;
var this__3923__auto____$1 = this;return (new aurora.util.core.FailedCheck(self__.message,self__.line,self__.file,self__.trace,G__10482,self__.__extmap,self__.__hash));
});
...
aurora.util.core.map__GT_FailedCheck = (function map__GT_FailedCheck(G__10484){return (new aurora.util.core.FailedCheck(new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(G__10484),new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(G__10484),new cljs.core.Keyword(null,"file","file",1017047278).cljs$core$IFn$_invoke$arity$1(G__10484),new cljs.core.Keyword(null,"trace","trace",1124525239).cljs$core$IFn$_invoke$arity$1(G__10484),null,cljs.core.dissoc.call(null,G__10484,new cljs.core.Keyword(null,"message","message",1968829305),new cljs.core.Keyword(null,"line","line",1017226086),new cljs.core.Keyword(null,"file","file",1017047278),new cljs.core.Keyword(null,"trace","trace",1124525239))));
});
