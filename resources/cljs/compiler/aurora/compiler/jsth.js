...
}catch (e10456){var _ = e10456;return null;
}});
aurora.compiler.jsth.indent = (function indent(lines){return clojure.string.join.call(null,"\n",(function (){var iter__4055__auto__ = (function iter__10461(s__10462){return (new cljs.core.LazySeq(null,(function (){var s__10462__$1 = s__10462;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__10462__$1);if(temp__4092__auto__)
{var s__10462__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__10462__$2))
{var c__4053__auto__ = cljs.core.chunk_first.call(null,s__10462__$2);var size__4054__auto__ = cljs.core.count.call(null,c__4053__auto__);var b__10464 = cljs.core.chunk_buffer.call(null,size__4054__auto__);if((function (){var i__10463 = 0;while(true){
if((i__10463 < size__4054__auto__))
{var line = cljs.core._nth.call(null,c__4053__auto__,i__10463);cljs.core.chunk_append.call(null,b__10464,[cljs.core.str("  "),cljs.core.str(line)].join(''));
{
var G__10465 = (i__10463 + 1);
i__10463 = G__10465;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10464),iter__10461.call(null,cljs.core.chunk_rest.call(null,s__10462__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10464),null);
}
} else
{var line = cljs.core.first.call(null,s__10462__$2);return cljs.core.cons.call(null,[cljs.core.str("  "),cljs.core.str(line)].join(''),iter__10461.call(null,cljs.core.rest.call(null,s__10462__$2)));
}
} else
{return null;
}
...
}catch (e10467){if((e10467 instanceof aurora.util.core.FailedCheck))
{var e__4717__auto__ = e10467;throw cljs.core.update_in.call(null,e__4717__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",1124525239)], null),cljs.core.conj,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,x),new cljs.core.Symbol(null,"data->string","data->string",-962216859,null)));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e10467;
} else
...
}catch (e10469){if((e10469 instanceof aurora.util.core.FailedCheck))
{var e__4717__auto__ = e10469;throw cljs.core.update_in.call(null,e__4717__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",1124525239)], null),cljs.core.conj,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,x),new cljs.core.Symbol(null,"name->string","name->string",-1230645690,null)));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e10469;
} else
...
}catch (e10471){if((e10471 instanceof aurora.util.core.FailedCheck))
{var e__4717__auto__ = e10471;throw cljs.core.update_in.call(null,e__4717__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",1124525239)], null),cljs.core.conj,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,x),new cljs.core.Symbol(null,"var->string","var->string",-1290025246,null)));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e10471;
} else
...
}catch (e10473){if((e10473 instanceof aurora.util.core.FailedCheck))
{var e__4717__auto__ = e10473;throw cljs.core.update_in.call(null,e__4717__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",1124525239)], null),cljs.core.conj,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,x),new cljs.core.Symbol(null,"expression->string","expression->string",-179334829,null)));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e10473;
} else
...
}catch (e10475){if((e10475 instanceof aurora.util.core.FailedCheck))
{var e__4717__auto__ = e10475;throw cljs.core.update_in.call(null,e__4717__auto__,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",1124525239)], null),cljs.core.conj,cljs.core._conj.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,x),new cljs.core.Symbol(null,"statement->string","statement->string",-1752276694,null)));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e10475;
} else
