...
aurora.compiler.datalog.Knowledge.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3926__auto__,k6193,else__3927__auto__){var self__ = this;
var this__3926__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k6193,new cljs.core.Keyword(null,"axioms","axioms",3904992629)))
{return self__.axioms;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k6193,new cljs.core.Keyword(null,"facts","facts",1111091961)))
{return self__.facts;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k6193,new cljs.core.Keyword(null,"rules","rules",1122778217)))
{return self__.rules;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k6193,new cljs.core.Keyword(null,"guards","guards",4073761248)))
{return self__.guards;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k6193,else__3927__auto__);
} else
{return null;
}
}
...
aurora.compiler.datalog.Knowledge.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3931__auto__,k__3932__auto__,G__6192){var self__ = this;
var this__3931__auto____$1 = this;var pred__6195 = cljs.core.keyword_identical_QMARK_;var expr__6196 = k__3932__auto__;if(cljs.core.truth_(pred__6195.call(null,new cljs.core.Keyword(null,"axioms","axioms",3904992629),expr__6196)))
{return (new aurora.compiler.datalog.Knowledge(G__6192,self__.facts,self__.rules,self__.guards,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6195.call(null,new cljs.core.Keyword(null,"facts","facts",1111091961),expr__6196)))
{return (new aurora.compiler.datalog.Knowledge(self__.axioms,G__6192,self__.rules,self__.guards,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6195.call(null,new cljs.core.Keyword(null,"rules","rules",1122778217),expr__6196)))
{return (new aurora.compiler.datalog.Knowledge(self__.axioms,self__.facts,G__6192,self__.guards,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6195.call(null,new cljs.core.Keyword(null,"guards","guards",4073761248),expr__6196)))
{return (new aurora.compiler.datalog.Knowledge(self__.axioms,self__.facts,self__.rules,G__6192,self__.__meta,self__.__extmap,null));
} else
{return (new aurora.compiler.datalog.Knowledge(self__.axioms,self__.facts,self__.rules,self__.guards,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3932__auto__,G__6192),null));
}
}
}
}
...
aurora.compiler.datalog.Knowledge.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3923__auto__,G__6192){var self__ = this;
var this__3923__auto____$1 = this;return (new aurora.compiler.datalog.Knowledge(self__.axioms,self__.facts,self__.rules,self__.guards,G__6192,self__.__extmap,self__.__hash));
});
...
aurora.compiler.datalog.map__GT_Knowledge = (function map__GT_Knowledge(G__6194){return (new aurora.compiler.datalog.Knowledge(new cljs.core.Keyword(null,"axioms","axioms",3904992629).cljs$core$IFn$_invoke$arity$1(G__6194),new cljs.core.Keyword(null,"facts","facts",1111091961).cljs$core$IFn$_invoke$arity$1(G__6194),new cljs.core.Keyword(null,"rules","rules",1122778217).cljs$core$IFn$_invoke$arity$1(G__6194),new cljs.core.Keyword(null,"guards","guards",4073761248).cljs$core$IFn$_invoke$arity$1(G__6194),null,cljs.core.dissoc.call(null,G__6194,new cljs.core.Keyword(null,"axioms","axioms",3904992629),new cljs.core.Keyword(null,"facts","facts",1111091961),new cljs.core.Keyword(null,"rules","rules",1122778217),new cljs.core.Keyword(null,"guards","guards",4073761248))));
});
...
know.cljs$lang$applyTo = (function (arglist__6199){
var knowledge = cljs.core.first(arglist__6199);
var facts = cljs.core.rest(arglist__6199);
...
unknow.cljs$lang$applyTo = (function (arglist__6200){
var knowledge = cljs.core.first(arglist__6200);
var facts = cljs.core.rest(arglist__6200);
