...
aurora.compiler.match.MatchFailure.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3926__auto__,k6223,else__3927__auto__){var self__ = this;
var this__3926__auto____$1 = this;if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k6223,else__3927__auto__);
} else
{return null;
}
});
aurora.compiler.match.MatchFailure.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3931__auto__,k__3932__auto__,G__6222){var self__ = this;
var this__3931__auto____$1 = this;var pred__6225 = cljs.core.keyword_identical_QMARK_;var expr__6226 = k__3932__auto__;return (new aurora.compiler.match.MatchFailure(self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3932__auto__,G__6222),null));
});
...
aurora.compiler.match.MatchFailure.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3923__auto__,G__6222){var self__ = this;
var this__3923__auto____$1 = this;return (new aurora.compiler.match.MatchFailure(G__6222,self__.__extmap,self__.__hash));
});
...
aurora.compiler.match.map__GT_MatchFailure = (function map__GT_MatchFailure(G__6224){return (new aurora.compiler.match.MatchFailure(null,cljs.core.dissoc.call(null,G__6224)));
});
