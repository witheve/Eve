...
class BSPhase {
  ...
  addEntity(entity:string, name:string, kinds:string[], attributes?:{}, extraContent?:string) {
    ...
    for(let kind of kinds) {
        ...
        let collEntity = `AUTOGENERATED ${kind} THIS SHOULDN'T SHOW UP ANYWHERE`;
...
app.init("bootstrap", function bootstrap() {
  ...
  phase.addArtifacts(parseDSL(unpad(4) `
    (query
      ...
      (project! "entity eavs" :entity entity :attribute "is a" :value "AUTOGENERATED entity THIS SHOULDN'T SHOW UP ANYWHERE"))
  `));
  phase.addArtifacts(parseDSL(unpad(4) `
    (query
