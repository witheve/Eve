...
import {copy, uuid, coerceInput, autoFocus, KEYS, mergeObject, setEndOfContentEditable} from "./utils";
...
appHandle("create query", (changes:Diff, {id, content}) => {
  ...
  changes
    ...
    .add("sourced eav", {entity: id, attribute: "is a", value: "AUTOGENERATED query THIS SHOULDN'T SHOW UP ANYWHERE"})
