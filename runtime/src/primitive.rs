...
pub fn primitives() -> Vec<(&'static str, Vec<&'static str>, Vec<&'static str>, Vec<&'static str>)> {
    vec![
        ...
        ("<=", vec!["in A", "in B"], vec![], vec![]),
        ("!=", vec!["in A", "in B"], vec![], vec![]),
        ("+", vec!["in A", "in B"], vec![], vec!["result"]),
        ("-", vec!["in A", "in B"], vec![], vec!["result"]),
        ("*", vec!["in A", "in B"], vec![], vec!["result"]),
        ("/", vec!["in A", "in B"], vec![], vec!["result"]),
        ("remainder", vec!["in A", "in B"], vec![], vec!["result"]),
        ("round", vec!["in A", "in B"], vec![], vec!["result"]),
        ...
        ("count", vec![], vec!["in"], vec!["result"]),
        ("sum", vec![], vec!["in"], vec!["result"]),
        ("mean", vec![], vec!["in"], vec!["result"]),
        ("standard deviation", vec![], vec!["in"], vec!["result"]),
    ]
}
