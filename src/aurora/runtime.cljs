...
(defn env []
  (let [kn (knowledge)
    ...
    (.get-or-create-index kn "know" "ui/editor-elem" #js ["clause-id"])
    (.get-or-create-index kn "know" "ui/editor-child" #js ["clause-id"])
    (.get-or-create-index kn "know" "ui/editor-attr" #js ["clause-id"])
    (.get-or-create-index kn "know" "ui/editor-text" #js ["clause-id"])
    (.get-or-create-index kn "know" "ui/editor-style" #js ["clause-id"])
    (.get-or-create-index kn "know" "ui/editor-event-listener" #js ["clause-id"])
    (.get-or-create-index kn "know" "ui/editor-computed-id" #js ["id" "parent" "pos"])
    (init-std-lib kn)
