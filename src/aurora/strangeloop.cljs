...
(def ds '{:data {}  :pipes [{:name root :pipe [(get-data) (filter-match [gt10 (fn [x] (> x 10))] {"time" (_ :guard gt10)} _PREV_) (group-by "date" _PREV_) (vals _PREV_) (each _PREV_ do-math) (core/!chart {"type" "line" "values" _PREV_ "bezierCurve" true "x" ["monday" "tuesday" "wednesday" "thursday" "friday"]}) ]}  {:name get-data :desc "get data" :pipe [[{"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/28/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 114 "date" "8/29/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 90 "date" "8/30/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 19 "date" "8/28/2013"} {"time" 3 "date" "8/28/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 59 "date" "8/26/2013"} {"time" 23 "date" "8/26/2013"} {"time" 224 "date" "8/27/2013"} {"time" 70 "date" "8/27/2013"} {"time" 159 "date" "8/30/2013"} {"time" 10 "date" "8/30/2013"} {"time" 66 "date" "8/30/2013"} {"time" 79 "date" "8/30/2013"} ] ]}  {:name do-math :desc "" :scope [thing] :pipe [(core/extract thing "time") (core/!math ["/" ["sum" _PREV_] ["count" _PREV_]]) ]}  ]  :main root})
...
(defn editor [prog]
 ...
 :pipes '[
         ...
         {:name op-lookup
          ...
          :pipe [
                 (match [op]
                        ...
                        ['core/group-by] (list "Group these " (step-rep pipe (ensure-meta (second args) (cljs.core/conj (-> call meta :path) 2))) " by the value of " (step-rep pipe (ensure-meta (first args) (cljs.core/conj (-> call meta :path) 1))))
         ...
         {:name ->group
          :scope [pipe step]
          :pipe [(let [path (-> step meta :path)
                       form (list 'core/group-by "" (get-in program (rest path)))]
                   (-> (with-meta form {:path path})
                       (program-commute)))]}
