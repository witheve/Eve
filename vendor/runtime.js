...
var Indexer = (function () {
    ...
    Indexer.prototype.execTriggerIncremental = function (trigger, changes) {
        ...
        var diff = new exports.Diff(this);
        if (adds.length) {
...
// Builtin Primitives
//---------------------------------------------------------
exports.define("count", { aggregate: true, result: "count" }, function (prev) {
    if (!prev.count) {
        prev.count = 0;
    }
    prev.count++;
...
exports.define("sum", { aggregate: true, result: "sum" }, function (prev, value) {
    if (!prev.sum) {
        prev.sum = 0;
    }
    prev.sum += value;
...
exports.define("average", { aggregate: true, result: "average" }, function (prev, value) {
    if (!prev.sum) {
        prev.sum = 0;
        prev.count = 0;
    }
...
exports.define("lowercase", { result: "result" }, function (text) {
    if (typeof text === "string") {
        return { result: text.toLowerCase() };
    }
    return { result: text };
});
exports.define("=", { filter: true, inverse: "!=" }, function (a, b) {
    return a === b ? exports.SUCCEED : exports.FAIL;
});
exports.define("!=", { filter: true, inverse: "=" }, function (a, b) {
    return a !== b ? exports.SUCCEED : exports.FAIL;
});
...
exports.define("+", { result: "result" }, function (a, b) {
    return { result: a + b };
});
exports.define("-", { result: "result" }, function (a, b) {
    return { result: a - b };
